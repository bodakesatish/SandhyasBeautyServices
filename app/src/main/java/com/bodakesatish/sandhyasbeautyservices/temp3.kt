...
//import com.bodakesatish.sandhyasbeautyservices.domain.model.AppointmentCustomer // Assuming this is your data class
//import com.bodakesatish.sandhyasbeautyservices.util.DateHelper // Assuming DateHelper exists
//
...
//    var onAppointmentSelected: ((AppointmentCustomer) -> Unit)? = null // Renamed for clarity
//
...
//    fun setData(newData: List<AppointmentCustomer>) {
//        val diffResult = DiffUtil.calculateDiff(AppointmentDiffCallback(this.itemList, newData))
//        this.itemList = newData // Update the internal data list
//        diffResult.dispatchUpdatesTo(this) // Dispatch the calculated updates to the adapter
//    }
//
//    // Renamed setOnClickListener for clarity
//    fun setOnAppointmentSelectedListener(onAppointmentSelected: ((AppointmentCustomer)) -> Unit) {
...
//                onAppointmentSelected?.invoke(data) // Using the renamed listener
//            }
//        }
//    }
//
