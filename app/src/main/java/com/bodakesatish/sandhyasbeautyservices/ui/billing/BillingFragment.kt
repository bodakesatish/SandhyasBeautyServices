...
class BillingFragment : Fragment() {
    ...
    private fun setupHeader() {
        binding.headerGeneric.tvHeader.setText(getString(R.string.billing_details))
        binding.headerGeneric.btnBack.setImageResource(R.drawable.ic_back_24)
        binding.headerGeneric.btnBack.setOnClickListener {
            findNavController().popBackStack()
        }
...
//        }
    ...
    private fun setupFragmentResultListener() {
        childFragmentManager.setFragmentResultListener(
            ...
            val serviceId = bundle.getInt(EditServiceDiscountDialogFragment.RESULT_SERVICE_ID, 0)
            val discountAmount =
                bundle.getDouble(EditServiceDiscountDialogFragment.RESULT_DISCOUNT_AMOUNT, 0.0)
